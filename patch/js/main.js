...
(function(){
    ...
    function fnLogout(){
      ...
      function fnVerify(){
       var user = firebase.auth().currentUser;
        document.getElementById("verify").innerHTML =("Bekreftelse Link Er Sendt!");
    ...
    function fnRepass(){
        ...
        firebase.auth().sendPasswordResetEmail(email)
          .then(function() {
            document.getElementById("reset").innerHTML =("Tilbakestill Passord link er sendt.");
          });
        }
    ...
    firebase.auth().onAuthStateChanged(function(user) {
        if (user) {
          ...
          if(user != null){
            ...
            document.getElementById("user_para").innerHTML =  "<br><br><br>E-Post : " + email_id + " <br><br>Bekreftet konto : " + email_Verified;
          }
